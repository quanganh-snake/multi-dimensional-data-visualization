...
## 📌 Insight từ các biểu đồ trong thư mục output

1. **global_temp_heatmap.png**
   - Xu hướng ấm lên dài hạn rất rõ: giai đoạn đầu (khoảng 1880-1940) chủ yếu là dị thường âm hoặc gần 0, trong khi từ thập niên 1990 trở đi hầu hết các tháng chuyển sang dị thường dương.
   - Mức độ ấm lên tăng mạnh trong giai đoạn gần đây: từ 2015-2025, gần như toàn bộ các tháng đều có sắc đỏ đậm, nhiều tháng tiệm cận mức +1.0 đến +1.5°C so với mốc 1951-1980.
   - Tín hiệu ấm lên diễn ra quanh năm thay vì chỉ tập trung vào một mùa cụ thể, cho thấy biến đổi nền khí hậu toàn cầu có tính hệ thống theo cả 12 tháng.

2. **minnesota_precip_line.png**
   - Lượng mưa theo tháng biến động mạnh theo thời gian và theo địa điểm, với nhiều đỉnh mưa cục bộ vượt 6 inch; cá biệt có đỉnh xấp xỉ 10 inch (Waseca), phản ánh tính thất thường cao của mưa theo tháng.
   - Các địa điểm có xu hướng đồng pha ở một số giai đoạn (nhiều đường cùng tăng), nhưng biên độ khác nhau rõ rệt, cho thấy cùng một tác động thời tiết vùng nhưng mức đáp ứng tại từng site khác nhau.
   - Waseca, StPaul và Duluth thường xuất hiện các đỉnh cao hơn nhóm còn lại, trong khi Crookston và Morris có nhiều giai đoạn thấp hơn tương đối.

3. **weather_heatmap.png**
   - Mumbai nóng ổn định quanh năm (khoảng 75-87°F), biên độ mùa nhỏ, thể hiện đặc trưng khí hậu nhiệt đới nóng ẩm.
   - Beijing và Chicago có biên độ nhiệt theo mùa lớn nhất: mùa đông lạnh (xấp xỉ 25-35°F) và mùa hè nóng (xấp xỉ 73-81°F), phản ánh khí hậu lục địa rõ rệt.
   - Auckland có chu kỳ mùa đảo ngược so với Bắc bán cầu (ấm hơn vào đầu/cuối năm, mát hơn giữa năm), còn San Diego duy trì nền nhiệt ôn hòa và dao động thấp hơn hai thành phố lục địa.

4. **weather_scatter.png**
   - Cụm điểm tách theo thành phố rất rõ: Mumbai tập trung ở vùng nhiệt độ cao và độ ẩm cao; Chicago và Beijing phân tán rộng theo trục nhiệt độ, cho thấy tính mùa vụ mạnh.
   - Quan hệ nhiệt độ-độ ẩm không tuyến tính đơn giản cho toàn bộ dữ liệu; mỗi thành phố có cấu trúc cụm riêng, nên phân tích tổng hợp toàn cục dễ che mờ đặc điểm địa phương.
   - Các điểm có kích thước lớn (mưa nhiều) chủ yếu xuất hiện trong vùng độ ẩm trung bình đến cao (thường trên khoảng 60%), gợi ý mưa lớn có xu hướng đi kèm điều kiện ẩm cao.
